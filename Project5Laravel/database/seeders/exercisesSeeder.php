...
class exercisesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('exercises')->insert([
            'titleEN' => 'Plank',
            'titleNL' => 'Plank',
            'instructionEN' => 'Step 1: Get down on all fours, place your hands further than your shoulders. \n Step 2: Straighten your arms and legs. (Get into a push-up position.) \n Step 3: Bow your elbows and rest your weight on your arms and on your toes, keep your body straight. \n Step 4: Hold for as long as you can.',
            'instructionNL' =>'Stap 1: Ga op handen en voeten staan en plaats je handen iets breder dan je schouders. \n Stap 2: Strek je armen en benen. (Ga in een push-up positie staan.) \n Stap 3: Buig je ellenbogen en rust je gewicht op je armen en je tenen. Houd je lichaam recht. \n Stap 4: Houd dit vast zolang je kunt.',
